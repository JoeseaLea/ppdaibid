...
CREATE TABLE debtinfo(
	id INT(12) PRIMARY KEY AUTO_INCREMENT COMMENT '主键', 
	debtdealId INT(12) COMMENT '债权ID',
	owingNumber INT(4) COMMENT '剩余期数',
	priceforSale DOUBLE(12, 2) COMMENT '转让价',
	listingId INT(12) COMMENT '列表ID',
	creditCode VARCHAR(4) COMMENT '列表等级',
	amount DOUBLE(12, 2) COMMENT '借款金额',
	months INT(4) COMMENT '期限',
	debtId INT(12) COMMENT '债转编号',
	seller VARCHAR(32) COMMENT '转出人',
	statusId INT(1) COMMENT '1出售中2已完成 0其它无效状态',
	...
	remainFunding DOUBLE(12, 2) COMMENT '可投标金额',
	deadLineTimeOrRemindTimeStr VARCHAR(32) COMMENT '截止时间',
	currentRate DOUBLE(4, 2) COMMENT '利率',
	borrowName VARCHAR(32) COMMENT '借款人的用户名',
	gender INT(2) COMMENT '性别 1 男 2 女 0 未知',
	educationDegree VARCHAR(64) COMMENT '学历',
	graduateSchool VARCHAR(64) COMMENT '毕业院校',
	studyStyle VARCHAR(32) COMMENT '学习形式',
	age INT(3) COMMENT '年龄',
	successCount INT(6) COMMENT '成功借款次数',
	wasteCount INT(6) COMMENT '流标次数',
	cancelCount INT(6) COMMENT '撤标次数',
	failedCount INT(6) COMMENT '失败次数',
	normalCount INT(6) COMMENT '正常还清次数',
	overdueLessCount INT(6) COMMENT '逾期(1-15)还清次数',
	overdueMoreCount INT(6) COMMENT '逾期(15天以上)还清次数',
	owingAmount DOUBLE(12, 2) COMMENT '待还金额',
	amountToReceive DOUBLE(12, 2) COMMENT '待收金额',
	firstSuccessBorrowTime VARCHAR(32) COMMENT '第一次成功借款时间',
	registerTime VARCHAR(32) COMMENT '注册时间',
	certificateValidate INT(2) COMMENT '学历认证 0 未认证 1已认证',
	nciicIdentityCheck INT(2) COMMENT '户籍认证 0 未认证 1已认证',
	phoneValidate INT(2) COMMENT '手机认证 0 未认证 1已认证',
	videoValidate INT(2) COMMENT '视屏认证 0 未认证 1已认证',
	creditValidate INT(2) COMMENT '征信认证 0 未认证 1已认证',
	educateValidate INT(2) COMMENT '学籍认证 0 未认证 1已认证',
	lastSuccessBorrowTime VARCHAR(32) COMMENT '最后一次成功借款时间',
	highestPrincipal DOUBLE(12, 2) COMMENT '单笔最高借款金额',
	highestDebt DOUBLE(12, 2) COMMENT '历史最高负债',
	totalPrincipal DOUBLE(12, 2) COMMENT '累计借款金额',
	...
	UNIQUE KEY debtdealId (debtdealId)
);
